  ...
  <div class="audit">
    ...
    <div v-if="result" class="result-section">
      ...
      <div class="vulnerabilities">
        ...
        <div v-for="(v, idx) in result.vulnerabilities" :key="`${v.type}-${v.line}-${idx}`" class="vuln-card" :class="v.severity">
      ...
      <div v-if="result.gasIssues.length > 0" class="gas-section">
        <h3>Gas优化建议</h3>
        <div v-for="(g, idx) in result.gasIssues" :key="`${g.functionName}-${idx}`" class="gas-card">
...
.vuln-line { font-size: 0.75rem; color: #7c3aed; font-family: monospace; margin-bottom: 0.5rem; }
.vuln-code { background: #f3f4f6; border-radius: 6px; padding: 0.5rem 0.75rem; font-size: 0.75rem; color: #374151; overflow-x: auto; margin: 0 0 0.5rem; white-space: pre-wrap; word-break: break-all; }
